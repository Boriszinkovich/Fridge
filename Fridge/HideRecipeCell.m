...
const NSString * theHideCellLabelsMaxXInset = @"28 25 20 18 15 12";

@implementation HideRecipeCell
...
- (void)setTheRecipeDescription:(NSString *)theRecipeDescription
{
    ...
    self.theDescriptionLabel.theWidth = self.theRightButton.theMinX - theHideCellLabelsMaxXInset.theDeviceValue - self.theDescriptionLabel.theMinX;
    [self.theDescriptionLabel sizeToFit];
    self.theBackgroundView.theHeight = [self methodGetHeight];
}
...
- (void)createAllViews
{
    ...
    UIView *theBackgroundHideView = [UIView new];
    self.theBackgroundView = theBackgroundHideView;
    [self.contentView addSubview:theBackgroundHideView];
